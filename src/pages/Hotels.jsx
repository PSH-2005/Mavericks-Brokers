...
const img_urls=[
  "https://content.skyscnr.com/available/1640818969/1640818969_WxH.jpg",
  "https://content.skyscnr.com/available/1859689538/1859689538_WxH.jpg",
  "https://content.skyscnr.com/available/1194437494/1194437494_WxH.jpg",
  "https://content.skyscnr.com/available/1779002074/1779002074_WxH.jpg",
  "https://content.skyscnr.com/available/1779002078/1779002078_WxH.jpg",
  "https://content.skyscnr.com/available/1674237730/1674237730_WxH.jpg"
]
      ...
      {activeTab === 'browse' && (
        <Container mt="5" w="90%" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 items-space-around">
          {hotels.map((hotel,index) => (
            ...
            //   </div>
            // </Card>
            <HotelCard name={hotel.name} location={hotel.location} image={img_urls[index]}/>
